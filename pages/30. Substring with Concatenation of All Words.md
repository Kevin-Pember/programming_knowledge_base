...
- Thinking Behind the Algorithm
	...
	- Lets go line by line in our implementation (Written based upon the [[Python Implementation]] )
		- The first variable we initialize is our word_count which is the number of words we have in our array. We will then use this value to first find whether there can be permutations,
- Implementation
